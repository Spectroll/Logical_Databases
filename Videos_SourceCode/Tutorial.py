...
class Tutorial(Scene):
    def construct(self):
        ...
        intro = Tex("Welcome! \nHere, we'll present some essential guidance on how to navigate the website and its animations.", color= BLACK, font_size= 36)
        intro.move_to([0, 3, 0])
        intro_foward = Tex("Scenes will begin playing once you enter the page.", color= BLACK, font_size= 36).next_to(intro, DOWN, buff= 2)
        intro_previous = Tex('You may hover over the video to see controls...', color= BLACK, font_size= 36).next_to(intro_foward, DOWN, buff= SMALL_BUFF)
        intro_replay = Tex('and use the section on left to navigate through the website!', color= BLACK, font_size= 36).next_to(intro_previous, DOWN, buff= SMALL_BUFF)
        ...
        #Parte 3
        to_elim = VGroup(intro, intro_foward, intro_previous, intro_replay)
        ...
        intro = Tex('Use the sections on the left to navigate through other types of transformations', color= BLACK, font_size= 38)
